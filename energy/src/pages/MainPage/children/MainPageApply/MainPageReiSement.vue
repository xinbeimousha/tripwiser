<template>
    <div class="trip-apply">
        <HeaderTitle title="报销申请" :btnLeft="true"  className="fa-plus" @back="goBack"/>
...
<script>
   ...
   import ReiSementYes from "./ReiSementYes.vue";
   import ReiSementNo from "./ReiSementNo.vue";
